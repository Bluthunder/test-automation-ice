...
package com.ch.integration.listener;
...
public class SuiteAlterListener implements IAlterSuiteListener {
	...
	public void alter(List<XmlSuite> suites) {
		...
		if (site != null && site.equalsIgnoreCase("AutoZone")) {
	...
	private String getPackagesForTestKSNA(String formFactor) {
		String desktopPkg = "com.ch.azo.desktoptests";
		String mobilePkg = "com.ch.azo.mobiletests";
		String tabletPkg = "com.ch.azo.tablettests";
		if (formFactor != null) {
